...
class EventsGui(GuiTestSetup):
    def __init__(self):
        super(EventsGui, self).__init__("artificial_events_multi_record")
...
class TestTables:
    ...
    def test_curve_fitting_column_wise(self):
        ...
        stored_tabledata, __ = self.get_curve_fitting_table(tgui, rec_from=rec_from, rec_to=rec_to,
                                                        regions=["reg_2", "reg_3"], region_keys=[self.cf_keys("min"),
                                                                                                 self.cf_keys("mean")],
                                                            file_idx=1)
    ...
    def test_curve_fitting_row_wise_different_analyses_across_files(self):
        ...
        self.check_curve_fitting_row_table(tgui, to_check=["1"], info={"file1_regions": file1_regions, "file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename, "file1_end_col": file1_end_col})

        # File 2, reg_2, reg_3, min, mean ------------------------------------------------------- -------------------------------------------------------------

        rec_from, rec_to = self.run_curve_fitting_analysis(tgui, "2")

        test_file2_col_keys = self.combine([self.cf_keys("min", add_filename=True),
                                            self.cf_keys("mean", add_filename=True)])
        file2_end_col = len(test_file2_col_keys)

        # need to calc num cols or hard code
        file2_col_keys, file2_filename = self.get_col_keys(tgui, 0, file2_end_col, "curve_fitting", row=file1_end_row + 1, return_filename=True)  # TODO: nicer way to this
        ...
        self.check_curve_fitting_row_table(tgui, to_check=["1", "2"], info={"file1_regions": file1_regions, "file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename, "file1_end_col": file1_end_col,
        ...
        self.check_curve_fitting_row_table(tgui, to_check=["1", "2", "3"], info={"file1_regions": file1_regions, "file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename, "file1_end_col": file1_end_col,
                                                                                 "file2_regions": file2_regions, "file2_col_keys": file2_col_keys, "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename, "file2_end_col": file2_end_col,
                                                                                 "file3_regions": file3_regions, "file3_col_keys": file3_col_keys, "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename, "file3_end_col": file3_end_col},
                                           rec_from=rec_from, rec_to=rec_to)
        ...
        test_file4_col_keys = self.combine([self.cf_keys("median", add_filename=True),
                                            self.cf_keys("triexp", add_filename=True)])

        file4_end_col = len(test_file4_col_keys)

        # need to calc num cols or hard code
        file4_col_keys, file4_filename = self.get_col_keys(tgui, 0, file4_end_col, "curve_fitting", row=file3_end_row + 1, return_filename=True)  # TODO: nicer way to this
        ...
        self.check_curve_fitting_row_table(tgui, to_check=["1", "2", "3", "4"], info={"file1_regions": file1_regions, "file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename, "file1_end_col": file1_end_col,
                                                                                      "file2_regions": file2_regions, "file2_col_keys": file2_col_keys, "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename, "file2_end_col": file2_end_col,
                                                                                      "file3_regions": file3_regions, "file3_col_keys": file3_col_keys, "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename, "file3_end_col": file3_end_col,
                                                                                      "file4_regions": file4_regions, "file4_col_keys": file4_col_keys, "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename, "file4_end_col": file4_end_col},
                                           rec_from=rec_from, rec_to=rec_to)
        ...
        test_file5_col_keys = self.combine([self.cf_keys("min", add_filename=True),
        ...
        # need to calc num cols or hard code
        file5_col_keys, file5_filename = self.get_col_keys(tgui, 0, file5_end_col, "curve_fitting", row=file4_end_row + 1, return_filename=True)  # TODO: nicer way to this
        ...
        self.check_curve_fitting_row_table(tgui, to_check=["1", "2", "3", "4", "5"], info={"file1_regions": file1_regions, "file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename, "file1_end_col": file1_end_col,
                                                                                           "file2_regions": file2_regions, "file2_col_keys": file2_col_keys, "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename, "file2_end_col": file2_end_col,
                                                                                           "file3_regions": file3_regions, "file3_col_keys": file3_col_keys, "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename, "file3_end_col": file3_end_col,
                                                                                           "file4_regions": file4_regions, "file4_col_keys": file4_col_keys, "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename, "file4_end_col": file4_end_col,
                                                                                           "file5_regions": file5_regions, "file5_col_keys": file5_col_keys, "file5_start_row": file5_start_row, "file5_end_row": file5_end_row, "file5_filename": file5_filename, "file5_end_col": file5_end_col},
                                           rec_from=rec_from, rec_to=rec_to)
    ...
    def cf_keys(self, analysis_type, add_filename=False):
        ...
        keys = {
            ...
            "biexp_event": ['record_num', 'b0', 'b1', 'fit_rise', 'fit_decay', 'r2', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2'],
            "triexp": ['record_num', 'baseline', 'peak', 'amplitude', 'b0', 'b1', 'tau1', 'b2', 'tau2', 'b3', 'tau3', 'r2'],
        }
    ...
    def run_curve_fitting_for_summary_statistics(self, tgui, region, analysis):
        ...
        """
        all_summary_statistics = {"file_1": {}, "file_2": {}, "file_3": {}, "file_4": {}}
        for file_idx in range(4):
            ...
            results, __ = self.get_curve_fitting_table(tgui, rec_from=rec_from, rec_to=rec_to, regions=[region], region_keys=[col_keys], file_idx=file_idx)
            num_recs = rec_to - rec_from + 1

            summary_statistics = {"data": {}, "col_keys": col_keys, "file_filename": tgui.fake_filename + " - " + "region " + region[-1],
                                  "rec_from": rec_from, "rec_to": rec_to, "num_recs": num_recs}

            summary_statistics = self.make_summary_statistics_from_column_data(results, summary_statistics, col_keys, rec_from, rec_to, num_recs, record_col_idx=0)
    ...
    def check_row_table_against_curve_fitting(self, tgui, file_regions, file_col_keys, file_row_start, file_row_end, file_filename, file_end_col, rec_from, rec_to, file_idx):
        ...
        stored_tabledata, __ = self.get_curve_fitting_table(tgui, rec_from=rec_from, rec_to=rec_to, regions=file_regions,  region_keys=split_list, file_idx=file_idx)

        data_on_table, text = self.get_table(tgui, row_start=file_row_start, row_end=file_row_end, col_start=0, col_end=file_end_col)
    ...
    def check_curve_fitting_row_table(self, tgui, to_check, info, rec_from=None, rec_to=None):
        ...
        """
        if "1" in to_check:
            self.check_row_table_against_curve_fitting(tgui, info["file1_regions"], info["file1_col_keys"], info["file1_start_row"], info["file1_end_row"], info["file1_filename"], info["file1_end_col"],
                                                       rec_from=0, rec_to=tgui.adata.num_recs - 1, file_idx=0)
        if "2" in to_check:
            self.check_row_table_against_curve_fitting(tgui, info["file2_regions"], info["file2_col_keys"], info["file2_start_row"], info["file2_end_row"], info["file2_filename"], info["file2_end_col"],
                                                       rec_from=rec_from, rec_to=rec_to, file_idx=1)
        if "3" in to_check:
            self.check_row_table_against_curve_fitting(tgui, info["file3_regions"], info["file3_col_keys"], info["file3_start_row"], info["file3_end_row"], info["file3_filename"], info["file3_end_col"],
                                                       rec_from=0, rec_to=tgui.adata.num_recs - 1, file_idx=2)
        if "4" in to_check:
            self.check_row_table_against_curve_fitting(tgui, info["file4_regions"], info["file4_col_keys"], info["file4_start_row"], info["file4_end_row"], info["file4_filename"], info["file4_end_col"],
                                                       rec_from=rec_from, rec_to=rec_to, file_idx=3)
        if "5" in to_check:
            self.check_row_table_against_curve_fitting(tgui, info["file5_regions"], info["file5_col_keys"], info["file5_start_row"], info["file5_end_row"], info["file5_filename"], info["file5_end_col"],
                                                       rec_from=rec_from, rec_to=rec_to, file_idx=4)
    ...
    def run_curve_fitting_analysis(self, tgui, file_num):
        ...
        if file_num == "2":
            __, rec_from, rec_to = tgui.handle_analyse_specific_recs(True)
            for region_name, func_type in zip(["reg_2", "reg_3"],
                                              ["min",    "mean"]):
                self.run_default_curve_fitting(tgui, func_type, region_name)
        ...
        if file_num == "4":
            __, rec_from, rec_to = tgui.handle_analyse_specific_recs(True)
            for region_name, func_type in zip(["reg_5", "reg_6"],
                                              ["median", "triexp"]):
                self.run_default_curve_fitting(tgui, func_type, region_name)
    ...
    def run_default_curve_fitting(self, tgui, func_type, region_name):
        test_curve_fitting.setup_and_run_curve_fitting_analysis(tgui,
                                                                func_type=func_type,
    ...
    def test_events_per_column_table(self):
        """
        ...
        tgui = EventsGui()
        tgui.mw.mw.actionBatch_Mode_ON.trigger()
        summary_statistics = {"file_1": {}, "file_2": {}, "file_3": {}, "file_4": {}, "file_5": {}}  # below, the order is fixed and should never change (it will if there is aproblem in script explain)
        summary_stats_headers = ['baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2', 'biexp_fit_b0', 'biexp_fit_b1', 'biexp_fit_rise', 'biexp_fit_decay', 'events_biexp_r2']
        ...
        assert file1_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2']
        ...
        assert file2_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'biexp_fit_b0', 'biexp_fit_b1', 'biexp_fit_rise', 'biexp_fit_decay', 'events_biexp_r2']
        ...
        assert file3_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay']
        ...
        assert file4_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'biexp_fit_b0', 'biexp_fit_b1', 'biexp_fit_rise', 'biexp_fit_decay', 'events_biexp_r2']
        ...
        assert file5_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2']
    ...
    def test_events_per_row_table(self):
        ...
        file1_col_keys, file1_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "events", row=0, return_filename=True)
        ...
        self.check_events_row_table(tgui, to_check=["1"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename})

        # File 2, max slope on, biexp on --------------------------------------------------------------------------------------------------------------------------------------------------

        rec_from, rec_to = self.run_events_test_file(tgui, to_run="2")

        file2_col_keys, file2_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "events", row=0, return_filename=True)

        assert file2_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2', 'biexp_fit_b0', 'biexp_fit_b1', 'biexp_fit_rise', 'biexp_fit_decay', 'events_biexp_r2']

        file2_start_row = file1_end_row + 1
        file2_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_events_row_table(tgui, to_check=["1", "2"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                     "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                     "rec_from": rec_from, "rec_to": rec_to})
        ...
        file3_col_keys, file3_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "events", row=0, return_filename=True)

        assert file3_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2', 'biexp_fit_b0', 'biexp_fit_b1', 'biexp_fit_rise', 'biexp_fit_decay', 'events_biexp_r2']

        file3_start_row = file2_end_row + 1
        file3_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_events_row_table(tgui, to_check=["1", "2", "3"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                          "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                          "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                          "rec_from": rec_from, "rec_to": rec_to})
        ...
        file4_col_keys, file4_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "events", row=0, return_filename=True)

        assert file4_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2', 'biexp_fit_b0', 'biexp_fit_b1', 'biexp_fit_rise', 'biexp_fit_decay', 'events_biexp_r2']

        file4_start_row = file3_end_row + 1
        file4_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_events_row_table(tgui, to_check=["1", "2", "3", "4"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                               "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                               "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                               "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename,
                                                                               "rec_from": rec_from, "rec_to": rec_to})
        ...
        file5_col_keys, file5_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "events", row=0, return_filename=True)

        assert file5_col_keys == ['event_num', 'template_num', 'record_num', 'event_time', 'baseline', 'peak', 'amplitude', 'rise', 'half_width', 'decay_perc', 'area_under_curve', 'event_period', 'max_rise', 'max_decay', 'monoexp_fit_b0', 'monoexp_fit_b1', 'monoexp_fit_tau', 'events_monoexp_r2', 'biexp_fit_b0', 'biexp_fit_b1', 'biexp_fit_rise', 'biexp_fit_decay', 'events_biexp_r2']

        file5_start_row = file4_end_row + 1
        file5_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_events_row_table(tgui, to_check=["1", "2", "3", "4", "5"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                    "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                    "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                                    "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename,
                                                                                    "file5_start_row": file5_start_row, "file5_end_row": file5_end_row, "file5_filename": file5_filename,
                                                                                    "rec_from": rec_from, "rec_to": rec_to})
    ...
    def check_column_table_against_events(self, tgui,
                                          file_col_keys, file_start_col, file_end_col,
                                          file_idx, rec_to, rec_from):
        """
        ...
        stored_tabledata = tgui.reshape_events_into_table(stored_tabledata)
        ...
        summary_statistics = self.make_summary_statistics_from_column_data(data_on_table, summary_statistics, file_col_keys, rec_from, rec_to, alt_num_recs, record_col_idx=2)

        return summary_statistics

    def check_row_table_against_events(self, tgui, file_row_start, file_row_end, file_filename, rec_from, rec_to,file_idx=0):
        """
    ...
    def check_events_row_table(self, tgui, to_check, info):
        """
        Convenience function for coordinating checking rows, see run_events_test_file() for hard coding.
        """
        if "1" in to_check:
            self.check_row_table_against_events(tgui, info["file1_start_row"], info["file1_end_row"], info["file1_filename"], rec_from=0, rec_to=13, file_idx=0)
        if "2" in to_check:
            self.check_row_table_against_events(tgui, info["file2_start_row"], info["file2_end_row"], info["file2_filename"], rec_from=info["rec_from"], rec_to=info["rec_to"], file_idx=1)
        if "3" in to_check:
            self.check_row_table_against_events(tgui, info["file3_start_row"], info["file3_end_row"], info["file3_filename"], rec_from=0, rec_to=13, file_idx=2)
        if "4" in to_check:
            self.check_row_table_against_events(tgui, info["file4_start_row"], info["file4_end_row"], info["file4_filename"], rec_from=0, rec_to=0, file_idx=3)
        if "5" in to_check:
            self.check_row_table_against_events(tgui, info["file5_start_row"], info["file5_end_row"], info["file5_filename"], rec_from=info["rec_from"], rec_to=info["rec_to"], file_idx=4)
    ...
    def test_skinetics_per_column_table(self):
        ...
        tgui = SpkcntTGui()
        tgui.mw.mw.actionBatch_Mode_ON.trigger()
        summary_statistics = {"file_1": {}, "file_2": {}, "file_3": {}, "file_4": {}, "file_5": {}}
        ...
        assert file1_col_keys == ['record_num', 'spike_number', 'spike_time', 'peak', 'amplitude', 'thr', 'rise_time', 'decay_time', 'fwhm', 'fahp', 'mahp']
        ...
        assert file2_col_keys == ['record_num', 'spike_number', 'spike_time', 'peak', 'amplitude', 'thr', 'rise_time', 'decay_time', 'fwhm', 'fahp', 'mahp', 'max_rise', 'max_decay']
        ...
        assert file3_col_keys == ['record_num', 'spike_number', 'spike_time', 'peak', 'amplitude', 'thr', 'rise_time', 'decay_time', 'fwhm', 'fahp', 'mahp', 'max_rise', 'max_decay']
        ...
        assert file4_col_keys == ['record_num', 'spike_number', 'spike_time', 'peak', 'amplitude', 'thr', 'rise_time', 'decay_time', 'fwhm', 'fahp', 'mahp']
        ...
        assert file5_col_keys == ['record_num', 'spike_number', 'spike_time', 'peak', 'amplitude', 'thr', 'rise_time', 'decay_time', 'fwhm', 'fahp', 'mahp',  'max_rise', 'max_decay']
    ...
    def test_skinetics_per_row_table(self):
        ...
        file1_col_keys, file1_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "skinetics", row=0, return_filename=True)
        ...
        self.check_skinetics_row_table(tgui, rec_from, rec_to, to_check=["1"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename})

        # File 2 --------------------------------------------------------------------------------------------------------------------------------------------------

        self.run_skinetics_test_file(tgui, "2")

        file2_col_keys, file2_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "skinetics", row=0, return_filename=True)
        ...
        self.check_skinetics_row_table(tgui, rec_from, rec_to, to_check=["1", "2"],  info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                           "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename})
        ...
        file3_col_keys, file3_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "skinetics", row=0, return_filename=True)
        ...
        self.check_skinetics_row_table(tgui, rec_from, rec_to, to_check=["1", "2", "3"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                               "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                               "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename})
        ...
        file4_col_keys, file4_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "skinetics", row=0, return_filename=True)

        assert file4_col_keys == ['record_num', 'spike_number', 'spike_time', 'peak', 'amplitude', 'thr', 'rise_time', 'decay_time', 'fwhm', 'fahp', 'mahp', 'max_rise', 'max_decay']

        file4_start_row = file3_end_row + 1
        file4_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_skinetics_row_table(tgui, rec_from, rec_to, to_check=["1", "2", "3", "4"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                                    "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                                    "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                                                    "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename})
        ...
        file5_col_keys, file5_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "skinetics", row=0, return_filename=True)
        ...
        self.check_skinetics_row_table(tgui, rec_from, rec_to, to_check=["1", "2", "3", "4", "5"], info={"file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                                         "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                                         "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                                                         "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename,
                                                                                                         "file5_start_row": file5_start_row, "file5_end_row": file5_end_row, "file5_filename": file5_filename})
    ...
    def check_skinetics_column_table(self, tgui, to_check, file_col_keys, file_start_col, file_end_col, summary_statistics, rec_from=None, rec_to=None):
        """
        ...
        if "1" in to_check:
            summary = self.check_column_table_against_skinetics(tgui, file_col_keys, file_start_col, file_end_col,
                                                                file_idx=0, rec_to=rec_to, rec_from=rec_from, max_slope=False)
            summary_statistics["file_1"] = summary

        elif "2" in to_check:
            summary = self.check_column_table_against_skinetics(tgui, file_col_keys, file_start_col, file_end_col,
                                                                file_idx=1, rec_to=rec_to, rec_from=rec_from)
            summary_statistics["file_2"] = summary

        elif "3" in to_check:
            summary = self.check_column_table_against_skinetics(tgui, file_col_keys, file_start_col, file_end_col,
                                                                file_idx=2, rec_from=0, rec_to=tgui.adata.num_recs - 1)
            summary_statistics["file_3"] = summary

        elif "4" in to_check:
            summary = self.check_column_table_against_skinetics(tgui, file_col_keys, file_start_col, file_end_col,
                                                                file_idx=3, rec_from=0, rec_to=tgui.adata.num_recs - 1,  max_slope=False)
            summary_statistics["file_4"] = summary

        elif "5" in to_check:
            summary = self.check_column_table_against_skinetics(tgui, file_col_keys, file_start_col, file_end_col,
                                                                file_idx=4, rec_to=rec_to, rec_from=rec_from)
            summary_statistics["file_5"] = summary

    def check_column_table_against_skinetics(self, tgui,
                                             file_col_keys, file_start_col, file_end_col,
                                             file_idx, rec_to, rec_from, max_slope=True):
        """
    ...
    def check_skinetics_row_table(self, tgui, rec_from, rec_to, to_check, info):
        ...
        if "1" in to_check:
            ...
            self.check_row_table_against_stored_tabledata_skinetics(tgui, info["file1_start_row"], info["file1_end_row"], info["file1_filename"],
                                                                    rec_from, rec_to, file_idx=0,
                                                                    max_slope=max_slope)
        if "2" in to_check:
            self.check_row_table_against_stored_tabledata_skinetics(tgui, info["file2_start_row"], info["file2_end_row"], info["file2_filename"],
                                                                    rec_from, rec_to, file_idx=1)
        if "3" in to_check:
            self.check_row_table_against_stored_tabledata_skinetics(tgui, info["file3_start_row"], info["file3_end_row"], info["file3_filename"],
                                                                    rec_from=0, rec_to=tgui.adata.num_recs - 1, file_idx=2)
        if "4" in to_check:
            self.check_row_table_against_stored_tabledata_skinetics(tgui, info["file4_start_row"], info["file4_end_row"], info["file4_filename"],
                                                                    rec_from=0, rec_to=tgui.adata.num_recs - 1, file_idx=3)
        if "5" in to_check:
            self.check_row_table_against_stored_tabledata_skinetics(tgui, info["file5_start_row"], info["file5_end_row"], info["file5_filename"],
                                                                    rec_from, rec_to, file_idx=4)

    def check_row_table_against_stored_tabledata_skinetics(self, tgui, file_row_start, file_row_end, file_filename, rec_from, rec_to, file_idx, max_slope=True):
        """
        ...
        assert np.array_equal(data_on_table, stored_tabledata, equal_nan=True), "row skinetics idx: {0}".format(file_idx)
    ...
    def test_input_resistance_per_column_table(self):
        ...
        assert file1_col_keys == ['record_num', 'user_input_im', 'vm_baseline', 'vm_steady_state', 'vm_delta', 'input_resistance']
        ...
        assert file2_col_keys == ['record_num', 'im_baseline', 'im_steady_state', 'im_delta', 'vm_baseline', 'vm_steady_state', 'vm_delta', 'input_resistance', 'sag_hump_peaks', 'sag_hump_ratio']
    ...
    def test_input_resistance_per_row_table(self):
        ...
        file1_col_keys, file1_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)

        assert file1_col_keys == ['record_num', 'user_input_im', 'input_resistance', 'vm_baseline', 'vm_steady_state', 'vm_delta']

        file1_start_row = 1
        file1_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_spkcnt_and_input_resistance_row_table(tgui, to_check=["1"],
                                                         info={"file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,},
                                                         analysis_type="Ri")
        ...
        file2_col_keys, file2_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)

        assert file2_col_keys == ['record_num', 'user_input_im', 'input_resistance', 'vm_baseline', 'vm_steady_state', 'vm_delta', 'im_baseline', 'im_steady_state', 'im_delta', 'sag_hump_peaks', 'sag_hump_ratio']

        file2_start_row = file1_end_row + 1
        file2_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_spkcnt_and_input_resistance_row_table(tgui, to_check=["1", "2"], info={"file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                          "file2_col_keys": file2_col_keys, "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                          "rec_from": rec_from, "rec_to": rec_to},
                                    analysis_type="Ri")
        ...
        file3_col_keys, file3_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)

        assert file3_col_keys == ['record_num', 'user_input_im', 'input_resistance', 'vm_baseline', 'vm_steady_state', 'vm_delta', 'im_baseline', 'im_steady_state', 'im_delta', 'sag_hump_peaks', 'sag_hump_ratio']

        file3_start_row = file2_end_row + 1
        file3_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_spkcnt_and_input_resistance_row_table(tgui, to_check=["1", "2", "3"], info={"file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                               "file2_col_keys": file2_col_keys, "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                               "file3_col_keys": file3_col_keys, "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                                               "rec_from": rec_from, "rec_to": rec_to},
                                    analysis_type="Ri")
        ...
        file4_col_keys, file4_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)

        assert file4_col_keys == ['record_num', 'user_input_im', 'input_resistance', 'vm_baseline', 'vm_steady_state', 'vm_delta', 'im_baseline', 'im_steady_state', 'im_delta', 'sag_hump_peaks', 'sag_hump_ratio']

        file4_start_row = file3_end_row + 1
        file4_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_spkcnt_and_input_resistance_row_table(tgui, to_check=["1", "2", "3", "4"], info={"file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                                    "file2_col_keys": file2_col_keys, "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                                    "file3_col_keys": file3_col_keys, "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                                                    "file4_col_keys": file4_col_keys, "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename,
                                                                                                    "rec_from": rec_from, "rec_to": rec_to},
                                    analysis_type="Ri")
        ...
        file5_col_keys, file5_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)

        assert file5_col_keys == ['record_num', 'user_input_im', 'input_resistance', 'vm_baseline', 'vm_steady_state', 'vm_delta', 'im_baseline', 'im_steady_state', 'im_delta', 'sag_hump_peaks', 'sag_hump_ratio']

        file5_start_row = file4_end_row + 1
        file5_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_spkcnt_and_input_resistance_row_table(tgui, to_check=["1", "2", "3", "4", "5"], info={"file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                                                         "file2_col_keys": file2_col_keys, "file2_start_row": file2_start_row, "file2_end_row": file2_end_row, "file2_filename": file2_filename,
                                                                                                         "file3_col_keys": file3_col_keys, "file3_start_row": file3_start_row, "file3_end_row": file3_end_row, "file3_filename": file3_filename,
                                                                                                         "file4_col_keys": file4_col_keys, "file4_start_row": file4_start_row, "file4_end_row": file4_end_row, "file4_filename": file4_filename,
                                                                                                         "file5_col_keys": file4_col_keys, "file5_start_row": file5_start_row, "file5_end_row": file5_end_row, "file5_filename": file5_filename,
                                                                                                         "rec_from": rec_from, "rec_to": rec_to},
                                    analysis_type="Ri")
    ...
    def test_spkcnt_per_column_table(self):
        ...
        assert file1_col_keys == ["record_num", "num_spikes", "user_input_im", "rheobase", "mean_isi_ms"]
        ...
        assert file2_col_keys == ["record_num", "num_spikes", "im_baseline", "im_steady_state", "im_delta", "rheobase", "fs_latency_ms", "mean_isi_ms", "spike_fa_divisor", "spike_fa_local_variance"]  # these are not hidden in spkcnt mode
    ...
    def test_spkcnt_per_row_table(self):
        ...
        assert file1_col_keys == ['record_num', 'num_spikes', 'user_input_im', 'mean_isi_ms', 'rheobase']  # TODO: note order is different to column

        file1_start_row = 1
        file1_end_row = tgui.mw.mw.table_tab_tablewidget.rowCount()

        self.check_spkcnt_and_input_resistance_row_table(tgui, to_check=["1"], info={"file1_col_keys": file1_col_keys, "file1_start_row": file1_start_row, "file1_end_row": file1_end_row, "file1_filename": file1_filename,
                                                                "rec_from": rec_from, "rec_to": rec_to})
        ...
        file2_col_keys, file2_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)
        assert file2_col_keys == ['record_num', 'num_spikes', 'user_input_im', 'mean_isi_ms', 'rheobase', 'im_baseline', 'im_steady_state', 'im_delta', 'fs_latency_ms', 'spike_fa_divisor', 'spike_fa_local_variance']
        ...
        file3_col_keys, file3_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)
        assert file3_col_keys == ['record_num', 'num_spikes', 'user_input_im', 'mean_isi_ms', 'rheobase', 'im_baseline', 'im_steady_state', 'im_delta', 'fs_latency_ms', 'spike_fa_divisor', 'spike_fa_local_variance']
        ...
        file4_col_keys, file4_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)
        assert file4_col_keys == ['record_num', 'num_spikes', 'user_input_im', 'mean_isi_ms', 'rheobase', 'im_baseline', 'im_steady_state', 'im_delta', 'fs_latency_ms', 'spike_fa_divisor', 'spike_fa_local_variance']
        ...
        file5_col_keys, file5_filename = self.get_col_keys(tgui, 1, tgui.mw.mw.table_tab_tablewidget.columnCount(), "spkcnt_and_input_resistance", row=0, return_filename=True)
        assert file5_col_keys == ['record_num', 'num_spikes', 'user_input_im', 'mean_isi_ms', 'rheobase', 'im_baseline', 'im_steady_state', 'im_delta', 'fs_latency_ms', 'spike_fa_divisor', 'spike_fa_local_variance']
    ...
    def fast_run_spkcnt(self, tgui, im_setting=False, analysis_to_run=False):
        ...
        if im_setting == "bounds":
            bounds_im = {"bl": [[0] * tgui.adata.num_recs, [0.1] * tgui.adata.num_recs],
        ...
        tgui.run_spikecount_analysis(analysis_to_run=analysis_to_run,
    ...
    def run_spkcnt_test_file(self, tgui, to_run=None):
        ...
        if to_run == "1":
            self.fast_run_spkcnt(tgui,
                                 "user_input_im",
                                 ["mean_isi_ms", "rheobase_record"])

        elif to_run == "2":
            __, rec_from, rec_to = tgui.handle_analyse_specific_recs(analyse_specific_recs=True)
            self.fast_run_spkcnt(tgui,
                                 "bounds",
                                 ["fs_latency_ms", "rheobase_exact", "spike_fa"])
        elif to_run == "3":
            self.fast_run_spkcnt(tgui,
                                 "im_protocol",
                                 ["rheobase_record"])
    ...
    def check_spkcnt_and_input_resistance_row_table(self, tgui, to_check, info,  analysis_type="spkcnt"):
        ...
        """
        if "1" in to_check:
            self.check_row_table_against_stored_tabledata(tgui, info["file1_col_keys"], info["file1_start_row"], info["file1_end_row"],  info["file1_filename"],
                                                          "record",
                                                          file_idx=0, analysis_type=analysis_type)
        if "2" in to_check:
            self.check_row_table_against_stored_tabledata(tgui, info["file2_col_keys"], info["file2_start_row"], info["file2_end_row"], info["file2_filename"],
                                                          "exact",
                                                          file_idx=1, rec_from=info["rec_from"], rec_to=info["rec_to"], analysis_type=analysis_type)
        if "3" in to_check:
            self.check_row_table_against_stored_tabledata(tgui, info["file3_col_keys"], info["file3_start_row"], info["file3_end_row"],  info["file3_filename"],
                                                          "record",
                                                          file_idx=2, analysis_type=analysis_type)
        if "4" in to_check:
            self.check_row_table_against_stored_tabledata(tgui, info["file4_col_keys"], info["file4_start_row"], info["file4_end_row"],  info["file4_filename"],
                                                          None,
                                                          file_idx=3,  rec_from=info["rec_from"], rec_to=info["rec_to"], analysis_type=analysis_type)
        if "5" in to_check:
            self.check_row_table_against_stored_tabledata(tgui, info["file5_col_keys"], info["file5_start_row"], info["file5_end_row"],  info["file5_filename"],
                                                          None,
                                                          file_idx=4, analysis_type=analysis_type)

    def check_spkcnt_or_input_resistance_column_table(self, tgui, to_check, file_col_keys, file_start_col, file_end_col, summary_statistics, analysis_type="spkcnt", rec_from=0, rec_to=None):
        """
        ...
        if "1" in to_check:
            summary = self.check_column_table_against_stored_tabledata(tgui, file_col_keys, file_start_col, file_end_col,
                                                                       "record",
                                                                       file_idx=0, analysis_type=analysis_type)
            summary_statistics["file_1"] = summary
            ...
            summary = self.check_column_table_against_stored_tabledata(tgui, file_col_keys, file_start_col, file_end_col,
                                                                       "exact",
                                                                       file_idx=1, analysis_type=analysis_type,
                                                                       rec_from=rec_from, rec_to=rec_to)
            summary_statistics["file_2"] = summary
            ...
            summary = self.check_column_table_against_stored_tabledata(tgui, file_col_keys, file_start_col, file_end_col,
                                                                       None,
                                                                       file_idx=3, analysis_type=analysis_type,
                                                                       rec_to=rec_to, rec_from=rec_from)
            summary_statistics["file_4"] = summary
    ...
    def check_column_table_against_stored_tabledata(self, tgui, file_col_keys, file_start_col, file_end_col,
                                                    rheobase_rec_or_exact, file_idx, rec_from=0, rec_to=None, analysis_type="Ri"):  # TODO: use for all analyses?
        """
        ...
        for col, col_key in enumerate(file_col_keys):
            ...
            if col_key == "rheobase":
                ...
                assert np.array_equal(stored_tabledata.loc[rec_from:rec_to, col_key], col_data_on_table, equal_nan=True)

                summary_statistics["data"][col_key] = {"M": np.mean(col_data_on_table), "SD": np.std(col_data_on_table, ddof=1), "SE": scipy.stats.sem(col_data_on_table),
                                                       "all_rec_data": {"M": stored_tabledata.loc[rec_from:rec_to, col_key], "SD": None, "SE": None}}

        return summary_statistics

    def check_row_table_against_stored_tabledata(self, tgui, file_col_keys, file_row_start, file_row_end, file_filename, rheobase_rec_or_exact, file_idx, rec_from=0, rec_to=None, analysis_type="Ri"):
        """
        """
        self.set_row_or_column_display(tgui, "row")
        self.check_row_filenames(tgui, file_row_start, file_row_end, file_filename)
    ...
    def check_summary_statistics(self, tgui, col_keys_union, summary_statistics, file_nums, analysis_type):
        ...
        for file_num in file_nums:
            ...
            # matches stored tabledata, and these summars are correct based on the tabledata.
            tgui.set_combobox(dialog.dia.calculate_across_records_combobox, 0)
            if dialog.dia.calculate_across_records_combobox.currentIndex() == 1:  # some Qt bug the above can fail
                tgui.mw.cfgs.analysis["summary_stats_within_rec"] = False

            for parameters in [["M", "SD", "SE"], ["M", "SE"], ["M", "SD"], ["SD", "SE"], ["M", "SE"], ["SD"], ["SE"]]:
                self.set_summary_statistics_parameter_checkboxes(tgui, dialog, parameters)

                check_function(tgui, summary_statistics, col_keys_union, row=int(file_num[-1]) + 1, parameters=parameters, file_num=file_num)
            ...
            start_row = np.cumsum([summary_statistics["file_" + str(filenum + 1)]["num_recs"] for filenum in range(file_idx)])[-1] if file_idx > 0 else 0

            file_num_recs = summary_statistics[file_num]["num_recs"]

            start_row += 2 + file_idx  # each file as one row of space underneath

            end_row = start_row + file_num_recs if file_num_recs == 1 else start_row + file_num_recs - 1 # TODO: fix these strange indexing issues with events...
            self.check_row_filenames(tgui, start_row, end_row, summary_statistics[file_num]["file_filename"])

            self.check_row_records(tgui, start_row, start_row + file_num_recs - 1, summary_statistics[file_num])

            for parameters in [["M", "SD", "SE"], ["M", "SE"], ["M", "SD"], ["SD", "SE"], ["M", "SE"], ["SD"], ["SE"]]:
                self.set_summary_statistics_parameter_checkboxes(tgui, dialog, parameters)

                for rec_idx, row in enumerate(range(start_row, start_row + file_num_recs - 1)):  # TODO: check and clean up
                    check_function(tgui, summary_statistics, col_keys_union, row, parameters, file_num, rec_mode_idx=rec_idx)
        ...
        if rec_mode_idx is None:
            ...
            for col, col_key in enumerate(col_keys_union):
                for parameter in parameters:
                    ...
                    if col_key not in summary_statistics[file_num]["data"]:
                        assert table.item(row, col_start) is None, "across recs null: {0} {1} {2}".format(file_num, col_key, parameter)
                    else:
                        assert float(self.get_item(tgui, row, col_start)) == summary_statistics[file_num]["data"][col_key][parameter], "across recs: {0} {1} {2}".format(file_num, col_key, parameter)

                    col_start += 1

        else:
            assert int(self.get_item(tgui, row, 1)) == rec_mode_idx + 1 + summary_statistics[file_num]["rec_from"],   "within recs rec num: {0} {1} {2}".format(file_num, col_key, parameter)  # TODO: this is accidently tested twice (in parent function also)
            ...
            for col, col_key in enumerate(col_keys_union):
                ...
                for parameter in parameters:
                    ...
                    if col_key not in summary_statistics[file_num]["data"]:
                        assert table.item(row, col_start) is None, "within recs null: {0} {1} {2}".format(file_num, col_key, parameter)

                    else:
                        sum_stat_data = summary_statistics[file_num]["data"][col_key]["all_rec_data"][parameter][rec_mode_idx]

                        if table.item(row, col_start).data(0) == "":
                            assert (sum_stat_data is None or np.isnan(sum_stat_data)), "empty fail {0} {1}".format(col_key, parameter)
                        else:
                            assert float(self.get_item(tgui, row, col_start)) == sum_stat_data, "within recs: {0} {1} {2}".format(file_num, col_key, parameter)
                    col_start += 1

    def check_spkcnt_ri_summary_stats_row(self, tgui, summary_statistics, col_keys_union, row, parameters, file_num, rec_mode_idx=None):
        """
        ...
        for col, col_key in enumerate(col_keys_union):
            ...
            if col_key not in summary_statistics[file_num]["col_keys"]:
                assert table.item(row, start_col) is None or table.item(row, start_col).data(0) == "", "empty failed {0}".format(col_key)
            ...
            for parameter in parameters:
                ...
                if rec_mode_idx is not None:
                    ...
                    self.check_spkcnt_summary_statistics_average_across_recs(table, col_key, row, start_col, sum_stat_data, parameter)

                start_col += 1

    def check_spkcnt_summary_statistics_average_within_recs(self, table, col_key, row, start_col, sum_stat_data, parameter, rec_mode_idx):
        """
        """
        if col_key in ["rheobase", "input_resistance"]:
            ...
            assert (sum_stat_data["all_rec_data"][parameter] is None or np.isnan(sum_stat_data["all_rec_data"][parameter].iloc[rec_mode_idx])), "empty fail {0}".format((col_key))
            ...
            if on_table_data is None:
                ...
                assert float(table.item(row, start_col).data(0)) == on_table_data.iloc[rec_mode_idx], "fail {0} {1}".format(col_key, parameter)

    def check_spkcnt_summary_statistics_average_across_recs(self, table, col_key, row, start_col, sum_stat_data, parameter):
        """
        """
        assert table.item(row, 1).data(0) == "All", "rec fail {0} {1}".format(col_keys, parameter)

        if table.item(row, start_col).data(0) == "":
            assert (sum_stat_data[parameter] is None or np.isnan(sum_stat_data[parameter])), "empty fail {0} {1}".format(col_key, parameter)

        elif col_key == "rheobase":
            assert float(table.item(row, start_col).data(0)) == sum_stat_data["M"], "rheobase fail {0} {1}".format(col_key, parameter)
        else:
            assert float(table.item(row, start_col).data(0)) == sum_stat_data[parameter], "fail {0} {1}".format(col_key, parameter)

    # Calc Summary Statistics
    # ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    def make_summary_statistics_from_column_data(self, data_on_table, summary_statistics, file_col_keys, rec_from, rec_to, num_recs, record_col_idx):
        """
        ...
        for col, key in enumerate(file_col_keys):
            ...
            summary_statistics["data"][key] = {"M": np.mean(col_data_on_table), "SD": np.std(col_data_on_table, ddof=1), "SE": scipy.stats.sem(col_data_on_table)}
            ...
            for idx, rec in enumerate(range(rec_from, rec_to + 1)):
                ...
                this_rec_indicies = np.where(data_on_table[:, record_col_idx] == rec + 1)
            ...
            summary_statistics["data"][key]["all_rec_data"] = {"M": all_rec_data_mean, "SD": all_rec_data_std, "SE": all_rec_data_ste}
    ...
    def check_input_resistance_stats_col_keys(self, tgui, file_start_col, file_end_col):
        ...
        """
        summary_stats_col_keys = self.get_col_keys(tgui, file_start_col, file_end_col, "spkcnt_and_input_resistance", row=1)  # just get all keys because first keys change as second keys written
        summary_stats_col_keys = self.get_summary_statistics_col_keys([summary_stats_col_keys])

        assert summary_stats_col_keys == ['record_num', 'user_input_im', 'vm_baseline', 'vm_steady_state', 'vm_delta', 'input_resistance', 'sag_hump_peaks', 'sag_hump_ratio', 'im_baseline', 'im_steady_state', 'im_delta']
    ...
    def check_spkcnt_summary_stats_col_keys(self, tgui, file_start_col, file_end_col):
        ...
        assert summary_stats_col_keys == ['record_num', 'num_spikes', 'user_input_im', 'rheobase', 'fs_latency_ms', 'mean_isi_ms', 'spike_fa_divisor', 'spike_fa_local_variance', 'im_baseline', 'im_steady_state', 'im_delta']
        return summary_stats_col_keys
    ...
    def set_row_or_column_display(self, tgui, row_or_column):
        ...
        if row_or_column == "row":
            tgui.switch_checkbox(tgui.mw.dialogs["analysis_statistics_options_dialog"].dia.file_per_row_radiobutton, on=True)

        elif row_or_column == "column":
            tgui.switch_checkbox(tgui.mw.dialogs["analysis_statistics_options_dialog"].dia.file_per_column_radiobutton, on=True)
    ...
    def get_col_keys(self, tgui, col_start, col_end, analysis_type, row=1, return_filename=False):
        ...
        file_col_keys = [utils.get_dict_key_from_value(file_header_dict, header) if header != "Filename" else "filename" for header in file_col_headers]
    ...
    def set_summary_statistics_parameter_checkboxes(self, tgui, dialog, parameters, set_all_on=True):
        ...
        """
        if set_all_on:
            self.set_summary_statistics_parameter_checkboxes(tgui, dialog, ["M", "SD", "SE"], set_all_on=False)  # first turn all on as checkbox will show if all are attemtped turned off
    ...
    def remove_bad_col_keys(self, tgui, summary_statistics, file_num, col_keys_union):
        ...
        summary_statistics[file_num]["col_keys"] = [summary_statistics[file_num]["col_keys"][i] for i in range(len(col_keys)) if col_keys[i]]
    ...
    def get_stored_tabledata(self, tgui, analysis_type, file_idx):
        if analysis_type == "spkcnt":  # TODO: OWN FUNCTION
            stored_tabledata = tgui.mw.stored_tabledata.spkcnt_data[file_idx]  # TODO: very similar to abouve but some awk differences so just live with some DRY
        elif analysis_type == "Ri":
            stored_tabledata = tgui.mw.stored_tabledata.ir_data[file_idx]  # TODO: very similar to abouve but some awk differences so just live with some DRY
    ...
    def get_curve_fitting_table(self, tgui, rec_from, rec_to, regions, region_keys, file_idx):  # TODO: merge with test_backup_options

        num_recs = rec_to - rec_from + 1  # if rec_from == 0 else rec_to - rec_from + 1  # TODO: OWN FUNCTION AS THIS REPEATED SO MUCH!!
        ...
        col = 0
        text = []
        for reg, region_col_keys in zip(regions, region_keys):  # RENAME ALL
    ...
    def get_events_data(self, analysed_recs, key):
        if key in ['record_num', 'b0', 'b1', 'fit_rise', 'fit_decay', 'r2']:
            ...
            data = np.array([entry["event_info"][list(entry["event_info"].keys())[0]][first_key][second_key] for entry in analysed_recs])
