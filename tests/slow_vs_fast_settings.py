def get_settings(slow_or_fast, data_type, num_recs=1):
    ...
    if data_type == "data_tools":
        if slow_or_fast == "slow":
            settings = {"num_recs": 75, "recs_to_split": 8}
        elif slow_or_fast == "fast":
            settings = {"num_recs": 5, "recs_to_split": 3}
            ...
            settings = {
                ...
                "manually_del": [
                    ...
                    [
                        ...
                        0,
                        "m_two",
                    ],  # higher first or plot peak idx becomes mismatched
                    [rec_from + 3, 0, "m_three"],
                    [rec_from + 8, 4, "m_four"],
                ],
            }
        elif slow_or_fast == "fast":
        ...
        if slow_or_fast == "slow":
            ...
            settings = {
                ...
                "manually_del": [
                    [2, 0, 2],
                    [1, 0, 1],
                ],  # so hacky, final idx 1 deletes the correct one
